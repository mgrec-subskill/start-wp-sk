...
if ( ! function_exists( 'empty_theme_setup' ) ) :
	...
	function empty_theme_setup() {
		 ...
		 * to change 'empty-theme' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'empty-theme', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'empty-theme' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'empty_theme_custom_background_args', array(
...
function empty_theme_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'empty-theme' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'empty-theme' ),
...
function empty_theme_scripts() {
	...
	wp_enqueue_script( 'empty-theme-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'empty-theme-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
